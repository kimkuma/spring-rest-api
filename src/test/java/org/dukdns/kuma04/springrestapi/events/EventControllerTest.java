...
public class EventControllerTest extends BaseControllerTest {
    ...
    public void createEvent() throws Exception{
        ...
        mockMvc.perform(post("/api/events")
                ...
                .andDo(document("create-event",
                        ...
                        relaxedResponseFields( // Relaxed 접두어 가능
    ...
    private Account createAccount() {
        Account kuma = Account.builder()
                ...
                .build();
        return this.accountService.saveAccount(kuma);
    }

    @Test
    @DisplayName("입력 받을 수 없는 값이 사용한 경우에 에러가 발생")
    ...
    @Test
    @DisplayName("입력 값이 비어가 있는 경우에 에러가 발생")
    ...
    @Test
    @DisplayName("30개의 이벤트를 10개씩 두번째 페이지 조회하기(인증정보가 있는 경우)")
    ...
    @Test
    @DisplayName("없는 이벤트는 조회했을때 4040 응답받기")
    ...
    @Test
    @DisplayName("입력값이 잘못된경우에 이벤트 수정 실패")
